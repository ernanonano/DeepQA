...
def my_embedding_rnn_seq2seq(encoder_inputs,
  ...
  with variable_scope.variable_scope(scope or "embedding_rnn_seq2seq") as scope:
    ...
    # Encoder.
    encoder_cell = tf.contrib.rnn.tf.contrib.rnn.EmbeddingWrapper(
    ...
    "embedding_rnn_seq2seq/rnn/embedding_wrapper/embedding:0"
    ...
    if isinstance(feed_previous, bool):
      ...
      return my_embedding_rnn_decoder(
          ...
          feed_previous=feed_previous, scope = "rnn/embedding_wrapper")
...
def my_embedding_attention_decoder(decoder_inputs,
                                initial_state,
                                attention_states,
                                cell,
                                num_symbols,
  ...
  with variable_scope.variable_scope(scope or "embedding_attention_decoder", dtype=dtype, reuse=True):
    embedding = variable_scope.get_variable("embedding",
                                            [num_symbols, embedding_size])
